                ...
                <table class="w-full table-auto"> <!-- Définition d'une table -->
                    ...
                    <tbody> <!-- Corps de la table -->
                        ...
                        <tr class="hover:bg-gray-100"> <!-- Ajout d'un effet de survol sur chaque ligne de la table -->
                            ...
                            <td class="px-4 py-2 text-center">{{ $agency->address }}</td>
                            <td class="px-4 py-2 text-center">{{ $agency->city }}</td>
                            <td class="px-4 py-2 text-center">{{ $agency->zip_code }}</td>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <table class="w-full table-auto"> <!-- Définition d'une table -->
                        ...
                        <tbody> <!-- Corps de la table -->
                            ...
                            <tr class="hover:bg-gray-100"> <!-- Ajout d'un effet de survol sur chaque ligne de la table -->
                                ...
                                <td class="px-4 py-2 text-center">{{ $vehicle->supplier->label }}</td>
